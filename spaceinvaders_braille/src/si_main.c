...
void init_game(si_struct *si, int f_width, int f_height) {
	...
	char *bllttexture    =  "textures/bullet.cdl";
	...
	init_player(&si->plrs, 6, 2, f_width, f_height, bllttexture, plrtexture);
	init_invaders(&si->invs, &si->plrs, 3, 9, 6, 2, 11, bllttexture, inv_textures);
